	...
	public void batchEmployeeInfoAll(EmployeeInfoTO employeeInfoTO) {
		...
		for(EmpInfoTO EmpInfoTO :employeeInfoTO.getEmpInfoList()){
			switch(EmpInfoTO.getStatus()){
				case "inserted" : empInfoDAO.insertEmpinfo(EmpInfoTO); break;
				case "updated" : empInfoDAO.updateEmpInfo(EmpInfoTO); break;
...
//		}
		...
		for(FamilyInfoTO familyInfoTO :employeeInfoTO.getFamilyInfoList()){
			switch(familyInfoTO.getStatus()){
				case "inserted" : familyInfoDAO.insertFamilyInfo(familyInfoTO); break;
				case "updated" : familyInfoDAO.updateFamilyInfo(familyInfoTO); break;
				case "deleted" : familyInfoDAO.deleteFamilyInfo(familyInfoTO); break;
			}
		}
		
		for(LicenseInfoTO licenseInfoTO :employeeInfoTO.getLicenseInfoList()){
			switch(licenseInfoTO.getStatus()){
				case "inserted" : licenseInfoDAO.insertLicenseInfo(licenseInfoTO); break;
				case "updated" : licenseInfoDAO.updateLicenseInfo(licenseInfoTO); break;
				case "deleted" : licenseInfoDAO.deleteLicenseInfo(licenseInfoTO); break;
			}
		}
		...
		for(EducationInfoTO educationInfoTO :employeeInfoTO.getEducationInfoList()){
			switch(educationInfoTO.getStatus()){
				case "inserted" : educationInfoDAO.insertEducationInfo(educationInfoTO); break;
				case "updated" : educationInfoDAO.updateEducationInfo(educationInfoTO); break;
				case "deleted" : educationInfoDAO.deleteEducationInfo(educationInfoTO); break;
			}
		}
