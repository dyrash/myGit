...
public interface ProductionServiceFacade {
   ...
   List<WorkInstructionTO> findWorkInstructionList(Map<String, Object> paramMap);
   ...
   void registPrm(HashMap<String, Object> paramMap,List<WorkInstructionTO> workInstructionList, List<PrmTO> prmList, List<StockTO> stockList,
