...
public class ProductionServiceFacadeImpl implements ProductionServiceFacade {
   ...
   @Override
   public List<WorkInstructionTO> findWorkInstructionList(Map<String, Object> paramMap) {
      // TODO Auto-generated method stub
      return workInstructionApplicationService.findWorkInstructionList(paramMap);
   }
   ...
   public List<PrmTO> findPrmList(HashMap<String,Object> dateMap) {
      // TODO Auto-generated method stub
      return prmApplicationService.findPrmList(dateMap);
   }

   @Override
   public void registPrm(HashMap<String, Object> paramMap,List<WorkInstructionTO> workInstructionList, List<PrmTO> prmList, List<StockTO> stockList , List<WarehousingTO> warehousingList ) {
      // TODO Auto-generated method stub
      prmApplicationService.registPrm(paramMap,workInstructionList, prmList, stockList, warehousingList);
   }
