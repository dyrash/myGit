...
public class BaseApplicationServiceImpl implements BaseApplicationService {
	...
	@Override
	public List<CodeTO> batchCodeListProcess(List<CodeTO> codeList) {
		// TODO Auto-generated method stub
		// TODO Auto-generated method stub
				for (CodeTO codeTO : codeList) {
					System.out.println(codeTO.getStatus());
					switch (codeTO.getStatus()) {
					case "inserted":
						//codeDetailDAO.insertCode(codeTO);
						System.out.println("insertCode");
						break;
					case "updated":
						//codeDetailDAO.updateCode(codeTO);
						System.out.println("updateCode");
						break;
					case "deleted":
						//codeDetailDAO.deleteCode(codeTO);
	...
	@Override
	public List<MenuTO> findSideMenuList() {
		// TODO Auto-generated method stub
		 	return menuDAO.selectSideMenuList();
	}
