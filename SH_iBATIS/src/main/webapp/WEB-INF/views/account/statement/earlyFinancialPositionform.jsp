...
<script>
	...
	function getEarlyAssetDataFunc() {
		...
		$("#assets").jqGrid({
			url: "${pageContext.request.contextPath}/account/statement/earlyFinancialPosition.do?method=findEarlyAssets",
			datatype:'json',
			data : assetList,
			jsonReader : {
				root : 'assetList'
	...
	function getEarlyLiabilitiseNequityDataFunc() {
		...
		$("#liabilitiesNequity").jqGrid({
			url: "${pageContext.request.contextPath}/account/statement/earlyFinancialPosition.do?method=findEarlyLiabilitiseNequity",
			datatype:'json',
			//data : assetList,
			jsonReader : {
				root : 'liabNequiList'
	...
	function getEarlyFinancialPositionDataFunc() {
		...
		$("#ealryFinancialPosition").jqGrid({
			url: "${pageContext.request.contextPath}/account/statement/earlyFinancialPosition.do?method=findEarlyFinancialPosition",
			datatype:'json',
