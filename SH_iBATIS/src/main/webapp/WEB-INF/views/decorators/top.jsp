...
<h4 align="right">
	...
	${sessionScope.empName}  ${sessionScope.detailCodeName}님  환영합니다!&emsp; &emsp; &emsp; &emsp; &emsp;&emsp;&emsp; &emsp; &emsp;<br>
	<%-- <%-- 권한 : ${sessionScope.authority} &emsp;
	직원번호  : ${sessionScope.empCode}  &emsp; &emsp; &emsp; &emsp; &emsp;&emsp;&emsp; &emsp; &emsp;<br>
	직급 : ${positionCode} &emsp;
	직   급 :  ${sessionScope.detailCodeName} &emsp; &emsp; &emsp; &emsp; &emsp;&emsp;&emsp; &emsp; &emsp;<br>
   ...
   <ul>
     ...
     <li class='has-sub'><a href='#'><span>인사 등록 관리</span></a>
       <ul> 
           ...
           <li onclick="permitted('ME006_1','${pageContext.request.contextPath}/hr/management/empinsertform.html')">
           <a href='#'><span>사원 등록</span></a>
           </li>
				
           <li onclick="permitted('ME006_2','${pageContext.request.contextPath}/hr/management/employeeform.html')">
        ...
        <li class='has-sub'><a href='#'><span>계정/코드 관리</span></a>
          <ul>
           ...
           <li onclick="permitted('ME001_2','${pageContext.request.contextPath}/account/base/accountform.html')">
      ...
      <li class='has-sub'><a href="#"><span>전표 관리</span></a>
         <ul>
          <li onclick="permitted('ME002_1','${pageContext.request.contextPath}/account/slip/slipform.html')">
      ...
      <li class='has-sub'><a href="#"><span>장부 관리</span></a>
         <ul>
            <li onclick="permitted('ME003_1','${pageContext.request.contextPath}/account/slip/journalform.html')">
         ...
         <li class='has-sub'><a href='#'><span>전기분재무제표</span></a>
          <ul> 
          <li onclick="permitted('ME004_1','${pageContext.request.contextPath}/account/statement/earlyFinancialPositionform.html')">
           <a href='#'><span>전기분재무상태표</span></a>
           </li>
           <li onclick="permitted('ME004_3','${pageContext.request.contextPath}/account/statement/earlyIncomeStatementform.html')">
         ...
         <li class='has-sub'><a href='#'><span>결산/재무제표</span></a>
          <ul> 
          <li onclick="permitted('ME004_1','${pageContext.request.contextPath}/account/statement/totaltrialbalanceform.html')">
           <a href='#'><span>합계잔액시산표</span></a>
           </li>
           <li onclick="permitted('ME004_2','${pageContext.request.contextPath}/account/statement/financialPositionform.html')">
           <a href='#'><span>재무상태표</span></a>
           </li> 
           <li onclick="permitted('ME004_3','${pageContext.request.contextPath}/account/statement/incomeStatementform.html')">
