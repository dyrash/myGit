...
function EmptyEmpBean(){  
    $.ajax({
           ...
           success: function(data, textStatus, jqXHR) {
               ...
               if (employeeBean.image == null || employeeBean.image == "")
       			$("#image")
       					.attr("src",
...
function insertFunc(){
    ...
    employeeBean.userPw = $("#emp_Password").val();
    ...
    employeeBean.socialSecurityNumber = $("#socialSecurityNumber").val();
    employeeBean.phoneNumber =  $("#phoneNumber").val();
    employeeBean.email = $("#email").val();
    //employeeBean.enteringDate = $("#enteringDate").val();
    employeeBean.birthDate = $("#birthDate").val();
    employeeBean.levelOfEducation = $("#levelOfEducation").val();
    employeeBean.zipCode = $("#zipCode").val();
    employeeBean.basicAddress =  $("#basicAddress").val();
    employeeBean.detailAddress = $("#detailAddress").val();
    employeeBean.image=$("#image").val();
	...
	$("#errorDialog").html("회원가입에 성공하셨습니다.");
		...
		modal : true,
 		...
 		buttons : {
  		ok : function(){
  		 $(this).dialog("close");
  		$(location).attr("href","${pageContext.request.contextPath}/hr/management/employeeform.html");
  		}
 		}
		 });
	});
...
<h1 align="center"><font>사원 등록</font></h1><br>
   <table align="left">
      <tr>
         <td><br><br><br><img src="" id="image" style="width: 300px; height: 350px">
            ...
            </form> <input type="hidden" id="image">
         </td>
   ...
   <table class="form-field-2" align="right" cellpadding="0" cellspacing="0" >
      ...
      <tr>
         ...
         <td><input type="text" class="form-field" id="socialSecurityNumber" size="13" placeholder="주민등록번호를 입력하세요 (-없이)" />
      </tr>
      <tr>
      	 <td id="classificationtitle">핸드폰번호</td>
         <td><input type="text" class="form-field" id="phoneNumber" size="11" placeholder="핸드폰번호를 입력하세요 (-없이)" ></td>
      </tr>
      <tr>
...
<!--       <tr>
      ...
      <tr>
         ...
         <td><input class="form-field" type="text" name="birthDate" size="30" id="birthDate" placeholder="생년월일" /></td>
      </tr>
      <tr>
      	 <td id="classificationtitle">최종학력</td>
         <td><input class="form-field" type="text" name="levelOfEducation" size="30" id="levelOfEducation" placeholder="최종학력" /></td>
      </tr>
      <tr>
