...
<script>
	...
	function getEarlyIncomeListDataFunc() {
		...
		$("#earlyIncomeList").jqGrid({
			url: "${pageContext.request.contextPath}/statement/earlyIncomeList.do?method=findEarlyIncomeList",
			datatype:'json',
	...
	function getEarlyIncomeStatementDataFunc() {
		...
		$("#earlyIncomeStatement").jqGrid({
			url: "${pageContext.request.contextPath}/statement/earlyIncomeStatement.do?method=findEarlyIncomeStatementList",
			datatype:'json',
