...
public class EarlyIncomeStatementDAOImpl implements EarlyIncomeStatementDAO{
	...
	private static EarlyIncomeStatementDAO instacne;
	private EarlyIncomeStatementDAOImpl(){}
	public static EarlyIncomeStatementDAO getInstance() {
		// TODO Auto-generated method stub
		if(instacne == null){
			instacne = new EarlyIncomeStatementDAOImpl();
			System.out.println("		@ earlyIncomeStatementDAOImpl에 접근");
		}
		return instacne;
