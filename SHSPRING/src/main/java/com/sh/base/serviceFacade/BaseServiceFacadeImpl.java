...
public class BaseServiceFacadeImpl implements BaseServiceFacade{
	...
	private CustomerListApplicationService customerListApplicationService;
	public void setCustomerListApplicationService(CustomerListApplicationService customerListApplicationService) {
			this.customerListApplicationService = customerListApplicationService;
		}
	...
	public HashMap<String, Object> accessToAuthority(String empCode, String empPassword, String deptCode) throws IdNotFoundException,DeptCodeNotFoundException, PwMissmatchException {
		...
		HashMap<String,Object> result=baseApplicationService.accessToAuthority(empCode, empPassword,deptCode);
		return result;
	}
	@Override
	...
	@Override
	public ArrayList<DepartmentCodeBean> selectDeptCodeList(String code) throws CodeListException {
		// TODO Auto-generated method stub
		ArrayList<DepartmentCodeBean> departmentCodeList = codeListApplicationService.selectDeptCodeList(code);
	...
	@Override
	public ArrayList<CustomerBean> selectCustomerCodeList(String code) throws CodeListException {
		// TODO Auto-generated method stub
		ArrayList<CustomerBean> customerList = customerListApplicationService.selectCustomerCodeList(code);
